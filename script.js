...
document.getElementById('envelope-btn').addEventListener('click', () => {
  ...
  document.getElementById('letter-intro').classList.add('hide');
  setTimeout(() => { btnToGallery.style.display = 'inline-block'; }, 500);
});
...
function launchConfetti() {
  ...
  container.innerHTML = '';
// Add your own confetti symbols here (emoji or text characters):
  const emojis = ['*'];
  for (let i = 0; i < 22; i++) {
